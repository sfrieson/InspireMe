...
ctrl.controller('ArtworkController', ['$scope','$http','DribbbleFactory', 'BehanceFactory',
    function ($scope, $http, DribbbleFactory, BehanceFactory) {
    $scope.results = [];
    $scope.shots = true;
    $scope.projects = true;
